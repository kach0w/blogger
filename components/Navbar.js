...
const Navbar = () => {
  ...
  return (
    <div id="nvbr" className='text-[#222] bg-[#f3f3f3] text-center flex space-x-6'>
      <div className='w-[100vw] z-0 text-[0.5rem] sm:text-[1.5rem] text-white pt-5 pb-5 h-15 align-middle z-3 font-serif'> 
        ...
        <div className='float-right sm:pr-20'>
          ...
          <a className='text-[white] text-[1.5rem] mb-1 inline-block align-middle pt-[0.36rem] pr-5  hover:text-slate-300' href="/entry">Entry</a> 
          <a className='text-[white] text-[1.5rem] mb-1 inline-block align-middle pt-[0.36rem] pr-5  hover:text-slate-300' href="/people">People</a> 
          <button id="signin" className='mt-1 pb-2 leading-sm inline-block align-middle pt-[0.36rem]  hover:text-slate-300' onClick={login}>Login / Sign Up</button>
          <button id="signout" className='mt-1 rounded-md pb-2 leading-sm align-middle pt-[0.36rem] hidden  hover:text-slate-300' onClick={signOut}>Sign Out</button>
          <img className='pl-3 inline-block w-[3rem]' src={imageurl} />
        </div>
      </div>
    </div>
  )
